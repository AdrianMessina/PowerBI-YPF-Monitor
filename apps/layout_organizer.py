"""
Layout Organizer - Integrado en YPF BI Monitor
Replica funcionalidad completa de pbi-layout-app
"""
...
def render_app(logger):
    """
    Wrapper para Layout Organizer integrado en YPF BI Monitor

    Args:
        logger: Logger de la suite para tracking de uso
    """

    # Import absoluto - NO requiere manipular sys.path
    import apps_core.layout_core.pbix_layout_tool as layout_tool
